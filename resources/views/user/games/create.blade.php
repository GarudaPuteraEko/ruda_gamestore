...
<div class="bg-gradient-to-b from-blue-100 to-white min-h-screen py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <form action="{{ route('user.games.store') }}" method="POST" enctype="multipart/form-data" id="game-create-form">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" class="w-full px-4 py-2 border border-blue-400 rounded-lg focus:ring-blue-600 focus:border-blue-600 bg-blue-200 text-blue-900">{{ old('description') }}</textarea>
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-blue-700 mb-1">File Game (ZIP / HTML5)</label>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        console.log('Create scripts loaded - DOM fully loaded');
