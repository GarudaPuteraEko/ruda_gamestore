...
<div class="bg-gradient-to-b from-blue-100 to-white min-h-screen py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <form action="{{ route('user.games.update', $game->id) }}" method="POST" enctype="multipart/form-data" id="game-edit-form">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <p class="text-sm text-blue-600 mt-1">Kosongkan jika tidak ingin mengganti file.</p>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-blue-600 mt-1">Format: JPG, JPEG, PNG, GIF. Maks: 2MB. Kosongkan jika tidak ingin mengganti gambar.</p>
                    @if ($game->image)
                        <div class="mt-2">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        console.log('Edit scripts loaded - DOM fully loaded');
