...
<div class="bg-gradient-to-b from-blue-100 to-white min-h-screen py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Judul -->
        <h1 class="text-3xl md:text-4xl font-bold text-blue-800 mb-8">Edit Game</h1>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <form action="{{ route('admin.games.update', $game->id) }}" method="POST" enctype="multipart/form-data" id="game-edit-form">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" class="w-full px-4 py-2 border border-blue-400 rounded-lg focus:ring-blue-600 focus:border-blue-600 bg-blue-200 text-blue-900 @error('description') border-red-500 @enderror">{{ old('description', $game->description) }}</textarea>
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-blue-700 mb-1">Ganti File Game (ZIP/HTML, Opsional)</label>
                    <input type="file" name="file" accept=".zip,.html" class="w-full px-4 py-2 border border-blue-400 rounded-lg focus:ring-blue-600 focus:border-blue-600 bg-blue-200 text-blue-900 @error('file') border-red-500 @enderror">
                    <p class="text-sm text-blue-600 mt-1">Format: ZIP atau HTML. Maks: 50MB. Kosongkan jika tidak ingin mengganti.</p>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-blue-600 mt-1">Format: JPG, JPEG, PNG, GIF. Maks: 2MB. Kosongkan jika tidak ingin mengganti.</p>
                    @if ($game->image)
                        <div class="mt-2">
                            <p class="text-sm text-blue-600">Gambar saat ini:</p>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        console.log('Admin edit scripts loaded - DOM fully loaded');
        ...
        if (submitButton) {
            submitButton.addEventListener('click', function(e) {
                ...
                Swal.fire({
                    ...
                    text: "Perubahan pada game akan disimpan. Pastikan semua informasi sudah benar!",
                    icon: 'info',
