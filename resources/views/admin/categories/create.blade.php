...
<div class="bg-gradient-to-b from-blue-100 to-white min-h-screen py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Judul -->
        <h1 class="text-3xl md:text-4xl font-bold text-blue-800 mb-8">Tambah Kategori</h1>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <form method="POST" action="{{ route('categories.store') }}" id="category-create-form">
                @csrf
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        console.log('Categories create scripts loaded - DOM fully loaded');
        ...
        if (submitButton) {
            submitButton.addEventListener('click', function(e) {
                ...
                Swal.fire({
                    ...
                    text: "Kategori akan disimpan. Pastikan nama sudah benar!",
                    icon: 'info',
